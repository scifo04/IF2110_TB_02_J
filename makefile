programmain: main/main.c
	...
	gcc -o lib/teman/temanreq_main lib/teman/temanreq_main.c lib/wordmachine/wordmachine.c lib/wordmachine/charmachine.c lib/account/account.c lib/affection/affection.c -lm
	clear
